...
class ProductDetailsRepo {
  ...
  Future<ApiResponse> getProduct(String productId, String codeLanguage) async {
    try {
      final response = await dioClient.get(
        AppConstants.PRODUCT_DETAILS_URI+productId, options: Options(headers: {AppConstants.LANG_KEY: codeLanguage}),
      );
