...
import 'package:flutter_sixvalley_ecommerce/helper/cache_helper.dart';
...
Future<void> main() async {
  ...
  debugPrint('State ------------> ' + AppConstants.STATE);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      locale: Provider.of<LocalizationProvider>(context).codeLocale,
