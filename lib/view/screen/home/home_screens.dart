...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _refreshData(BuildContext context, bool reload) async {
      ...
      if (event != null) {
        if (event.link != null) {
          ...
          if (type == 'id') {
            ...
            print(apiData);
            if (apiData['status'] == 1) {
              Product pro = Product.fromJson(apiData['data']['product']);
              print('qwe');
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          onRefresh: () async {
            await _refreshData(context, true);
...
Future<Map<String, dynamic>> handleApi(context,
  ...
  final String url = AppConstants.BASE_URL + '/api/' + route;
  try {
