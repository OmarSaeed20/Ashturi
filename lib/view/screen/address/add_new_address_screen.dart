...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  Future start() async {
    await checkPermission(
        () async => await Provider.of<LocationProvider>(context, listen: false)
                                    ...
                                    child: SizedBox(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          //   textInputAction:
                                          //       TextInputAction.next,
                                          //   initialValue: AppConstants.STATE,
                                          //   readOnly: true,
                                          // ),
                                          // SizedBox(
                                          //     height: Dimensions
...
Future checkPermission(Function callback, BuildContext context) async {
