            ...
            Consumer<SearchProvider>(
              builder: (context, searchProvider, child) {
                return !searchProvider.isClear
                    ...
                    //                     searchProduct(searchProvider.historyList[0], context),
                    ...
                    //                       child: Center(
                    //                         child: Text(Provider.of<SearchProvider>(context, listen: false).historyList[0] ?? "",
                    ...
                    //                       },
                    //                       child: Container(width: 100,color: Colors.red,padding: EdgeInsets.symmetric(horizontal:Dimensions.PADDING_SIZE_DEFAULT,
                    //                            ),
                    //                           child: Padding(
