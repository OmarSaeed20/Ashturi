                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              String url =
                                  await createDynamicLink(id: productModel.id);
                              print(url);
                              Share.share(url);
...
Future<String> createDynamicLink({bool short = true, @required int id}) async {
  // final String DynamicLink = 'https://ashturiapp.page.link?id=$id';
  final String DynamicLink = 'https://ashturiapp.page.link/product';
  // final String Link = 'https://reactnativefirebase.page.link/bFkn';
  final DynamicLinkParameters parameters = DynamicLinkParameters(
    uriPrefix: 'https://ashturiapp.page.link/product',
    longDynamicLink: Uri.parse(
      'https://ashturiapp.page.link/?link=https://ashturiapp.page.link?id%3D$id&apn=com.Ashturi.User',
    ),
    link: Uri.parse(DynamicLink),
    androidParameters: const AndroidParameters(
      packageName: 'com.Ashturi.User',
      minimumVersion: 0,
    ),
    iosParameters: const IOSParameters(
      bundleId: 'com.Ashturi.User',
      minimumVersion: '0',
    ),
  );
