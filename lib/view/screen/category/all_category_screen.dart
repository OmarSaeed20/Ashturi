      ...
      child: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          Container(
            ...
            width: 50,
            decoration: BoxDecoration(
              border: Border.all(color: isSelected ? Theme.of(context).highlightColor : Theme.of(context).hintColor),
            ...
            child: ClipRRect(
              ...
              // ),
              child:CacheNetworkImage(imageUrl: '${Provider.of<SplashProvider>
                (context,listen: false).baseUrls.categoryImageUrl}/$icon',
              ),
