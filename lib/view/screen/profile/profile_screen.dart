...
import '../auth/widget/show_progress_indicator.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    if (Provider.of<ProfileProvider>(context, listen: false)
      ...
      await Provider.of<ProfileProvider>(context, listen: false)
        ...
        if (response.isSuccess) {
          ...
          showCustomSnackBar('Updated Successfully', context, isError: !true);
  ...
  _updateState() async {
    CacheHelper.saveData(key: "STATE", value: AppConstants.STATE);

    CacheHelper.getData(key: "STATE").then((_) async {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                value: AppConstants.STATE,
                                items:
                                    AppConstants.states.map((String element) {
